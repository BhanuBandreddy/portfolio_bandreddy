...
const establish = (() => {
  ...
  const drafts: Draft[] = [
    { id: 'q-result', code: 'Q1', name: 'Business result', role: 'question one', group: 'ask', measure: { chars: 36 },
    ...
    { id: 'q-owner', code: 'Q2', name: 'Owner', role: 'question two', group: 'ask', measure: { chars: 23 },
    ...
    { id: 'q-baseline', code: 'Q3', name: 'Baseline', role: 'question three', group: 'ask', measure: { chars: 31 },
    ...
    { id: 'q-cause', code: 'Q4', name: 'Root cause', role: 'question four', group: 'ask', measure: { chars: 47 },
    ...
    { id: 'q-success', code: 'Q5', name: 'Success measure', role: 'question five', group: 'ask', measure: { chars: 43 },
    ...
    { id: 'reframe', code: 'RF', name: 'Objective reframe', role: 'the test', group: 'define', measure: { chars: 94 },
...
const navigate = (() => {
  ...
  const drafts: Draft[] = [
    ...
    { id: 'actual', code: 'AC', name: 'Actual work', role: 'what people really do', group: 'discover', measure: { chars: 120, count: 9 }, archetypeOverride: 'fin-row',
    ...
    { id: 'register', code: 'RG', name: 'Use-case register', role: 'the required deliverable', group: 'score', measure: { chars: 16 },
...
const context = (() => {
  ...
  const drafts: Draft[] = [
    { id: 'users', code: 'US', name: 'Users & channels', role: 'where a request starts', group: 'entry', measure: { chars: 69 },
    ...
    { id: 'orchestration', code: 'OR', name: 'Orchestration', role: 'the dispatcher', group: 'entry', measure: { chars: 69 },
    ...
    { id: 'contextlayer', code: 'CX', name: 'Context layer', role: 'what the org keeps', group: 'context', measure: { chars: 39 },
    ...
    { id: 'knowledge', code: 'KN', name: 'Knowledge graph', role: 'how entities relate', group: 'context', measure: { chars: 37 },
    ...
    { id: 'evidence', code: 'EV', name: 'Evidence & audit', role: 'what proves a decision', group: 'context', measure: { chars: 33 },
    ...
    { id: 'models', code: 'ML', name: 'Specialist models', role: 'rented, not owned', group: 'models', measure: { chars: 48 },
...
const release = (() => {
  ...
  const drafts: Draft[] = [
    ...
    { id: 'contract', code: 'EC', name: 'Execution contract', role: 'what every action must do', group: 'contract', measure: { chars: 32, count: 9 }, archetypeOverride: 'fin-row',
...
const prove = (() => {
  ...
  const drafts: Draft[] = [
    ...
    { id: 'dim-risk', code: 'RC', name: 'Risk & control', role: 'dimension three', group: 'dimensions', measure: { chars: 97 },
...
const institutionalise = (() => {
  ...
  const drafts: Draft[] = [
    ...
    { id: 'updates', code: 'UP', name: 'Context updates', role: 'what actually changes', group: 'loop', measure: { chars: 43 },
    ...
    { id: 'capture', code: 'CP', name: 'What is captured', role: 'the eight-item checklist', group: 'capture', measure: { chars: 48, count: 8 }, archetypeOverride: 'fin-row',
